...
label_class={'NC':0,'MCI':1,'AD':2}sim
...
if not data_augmentation:
       ...
       # checkpoint = ModelCheckpoint(checkpoint_filepath, monitor='acc', verbose=1, save_best_only=True, mode='max')
        ...
        # history=model.fit(x2_train, y2_train, batch_size=batch_size, steps_per_epoch=2,epochs=epoch_num,callbacks=[change_lr])
        history=model.fit(x2_train, y2_train, batch_size=batch_size,epochs=epoch_num)
