...
def fetch_data(root_path):
       ...
       # img_list2=read_img_list(Subject2,data_list_filter)
        ...
        global img_list1,img_label1,img_list2,img_label2
        for i in Subject1:
               Subject= data_list_filter[data_list_filter['Subject']==i].sort_values(by=['Visit'],ascending=True)
        ...
        for i in Subject2:
               ...
               Img_path =str(Subject_img_path['ImagePath'].values)
               data=read_data(Img_path[2:-2])
               data=resize(data,(1,256,256,256))
               img_list2.append(data)
               img_label2.append(Subject_img_path['label'].values)
        #return Subject_img_list1
        ...
        img_label2=np.array(img_label2)

        return img_list1,img_label1,img_list2,img_label2
...
img_label1=[]
img_label2=[]
img_list1,img_label1,img_list2,img_label2=fetch_data(root_path)
#img_list1=np.array(img_list1)
...
total_length=len(img_list1)
input_length=img_list1.ndim
...
out_ims, loss=rnn(img_list1,img_label1,num_layers,num_hidden,configs1)
